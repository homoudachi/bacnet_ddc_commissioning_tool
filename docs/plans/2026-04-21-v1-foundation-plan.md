...
- **2026-04-28 (Tauri):** **`desktop/tauri-operator/`** Tauri 2 operator shell + **`docs/packaging/tauri-operator-desktop.md`**, **`rust-toolchain.toml`**, CI **`.github/workflows/tauri-operator.yml`** (Linux `.deb` artifact).
