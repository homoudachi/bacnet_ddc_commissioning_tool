...
- **Docker BACnet sim (beyond bacnet-dev)** — orchestrator-in-container, BBMD / macvlan lab parity; **bacnet-dev** already runs **four** logical devices (three FCU + one HRV-shaped).
